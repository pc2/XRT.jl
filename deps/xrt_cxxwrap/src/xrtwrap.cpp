...
JLCXX_MODULE define_julia_module(jlcxx::Module& mod)
{
  ...
  .method("load_xclbin!", static_cast<xrt::uuid (xrt::device::*)(const std::string&)>(&xrt::device::load_xclbin))
  //.method("load_xclbin", static_cast<xrt::uuid (xrt::device::*)(const xrt::xclbin&)>(&xrt::device::load_xclbin))
  .method("get_xclbin_uuid", &xrt::device::get_xclbin_uuid);
  
  // Sync direction enum
  mod.add_bits<xclBOSyncDirection>("xclBOSyncDirection", jlcxx::julia_type("CppEnum"));
  ...
  .constructor<const xrt::device&, void*, size_t, xrt::bo::flags, xrt::memory_group>()
  .constructor<const xrt::device&, void*, size_t, xrt::memory_group>()
  .constructor<const xrt::device&, size_t, xrt::bo::flags, xrt::memory_group>()
  .constructor<const xrt::device&, size_t, xrt::memory_group>()
  .method("length", &xrt::bo::size,"Renamed xrt::bo::size to length to better fit Julia naming")
  .method("address", &xrt::bo::address)
  .method("get_memory_group", &xrt::bo::get_memory_group)
  .method("get_flags", &xrt::bo::get_flags)
  .method("async!", static_cast<xrt::bo::async_handle (xrt::bo::*)(xclBOSyncDirection, size_t, size_t)>(&xrt::bo::async))
  .method("async!", static_cast<xrt::bo::async_handle (xrt::bo::*)(xclBOSyncDirection)>(&xrt::bo::async))
  .method("sync!", static_cast<void (xrt::bo::*)(xclBOSyncDirection, size_t, size_t)>(&xrt::bo::sync))
  .method("sync!", static_cast<void (xrt::bo::*)(xclBOSyncDirection)>(&xrt::bo::sync))
  .method("map", static_cast<void* (xrt::bo::*)()>(&xrt::bo::map))
  .method("read", static_cast<void (xrt::bo::*)(void*, size_t, size_t)>(&xrt::bo::read))
  .method("read", static_cast<void (xrt::bo::*)(void*)>(&xrt::bo::read))
  .method("write!", static_cast<void (xrt::bo::*)(const void*, size_t, size_t)>(&xrt::bo::write))
  .method("write!", static_cast<void (xrt::bo::*)(const void*)>(&xrt::bo::write))
  .method("copy", static_cast<void (xrt::bo::*)(const xrt::bo&,size_t, size_t, size_t)>(&xrt::bo::copy))
  .method("copy", static_cast<void (xrt::bo::*)(const xrt::bo&)>(&xrt::bo::copy));
  ...
  .method("wait", static_cast<void (xrt::ip::interrupt::*)()>(&xrt::ip::interrupt::wait))
  .method("wait", [] (xrt::ip::interrupt &i, unsigned int ms) { i.wait(std::chrono::milliseconds(ms));});
  ...
  // Kernel
  mod.add_bits<xrt::kernel::cu_access_mode>("CUAccessMode", jlcxx::julia_type("CppEnum"));
  mod.set_const("XRT_KERNEL_ACCESS_EXCLUSIVE", xrt::kernel::cu_access_mode::exclusive);
  mod.set_const("XRT_KERNEL_ACCESS_SHARED", xrt::kernel::cu_access_mode::shared);
  mod.set_const("XRT_KERNEL_ACCESS_NONE", xrt::kernel::cu_access_mode::none);
   mod.add_type<xrt::kernel>("Kernel")
  .constructor<const xrt::device&, const xrt::uuid&, const std::string&, xrt::kernel::cu_access_mode>()
  ...
  .method("start", static_cast<void (xrt::run::*)(const xrt::autostart&)>(&xrt::run::start))
  .method("stop", &xrt::run::stop)
  .method("abort", &xrt::run::abort)
  // .method("wait", static_cast<ert_cmd_state (xrt::run::*)(const std::chrono::milliseconds&) const>(&xrt::run::wait))
  .method("wait", static_cast<ert_cmd_state (xrt::run::*)(unsigned int) const>(&xrt::run::wait))
  .method("set_arg!", static_cast<void (xrt::run::*)(int, xrt::bo&)>(&xrt::run::set_arg))
  .method("set_arg!", static_cast<void (xrt::run::*)(int,const xrt::bo&)>(&xrt::run::set_arg))
  .method("set_arg!", static_cast<void (xrt::run::*)(int, const void*, size_t)>(&xrt::run::set_arg))
